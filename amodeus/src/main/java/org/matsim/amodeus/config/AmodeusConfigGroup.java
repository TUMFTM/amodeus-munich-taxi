...
import org.matsim.amodeus.config.modal.*;
...
public class AmodeusConfigGroup extends ReflectiveConfigGroup {
    ...
    private LinkSpeedsConfig linkSpeedsConfig = new LinkSpeedsConfig();

    public AmodeusConfigGroup() {
        super(GROUP_NAME);
        super.addParameterSet(linkSpeedsConfig);
    }
    ...
    public ConfigGroup createParameterSet(final String type) {
        ...
        switch (type) {
            case AmodeusModeConfig.GROUP_NAME:
                return new AmodeusModeConfig();
            case LinkSpeedsConfig.GROUP_NAME:
                return new LinkSpeedsConfig();
            default:
    ...
    public void addParameterSet(ConfigGroup parameterSet) {
        ...
        if (parameterSet instanceof LinkSpeedsConfig) {
            return;
        }
    ...
    public LinkSpeedsConfig getLinkSpeedsConfig() {
        return linkSpeedsConfig;
    }

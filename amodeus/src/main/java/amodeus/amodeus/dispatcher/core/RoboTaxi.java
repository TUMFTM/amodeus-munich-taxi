...
public final class RoboTaxi {
    ...
    private boolean atTaxiRank = false;
    ...
    public void setAtTaxiRank(boolean atTaxiRank) {
        this.atTaxiRank = atTaxiRank;
    }
    ...
    /* package */ boolean notDrivingOnLastLink() {
        if (status.equals(RoboTaxiStatus.STAY))
            return true;
        //TODO: Needs to be checked, what happens if we want taxis driving to a depot
        if (status.equals(RoboTaxiStatus.OFFSERVICE))
            return true;
    ...
    public boolean isDivertable() {
        return !status.equals(RoboTaxiStatus.OFFSERVICE) && canReroute() && (usageType.equals(RoboTaxiUsageType.SHARED) || isWithoutCustomer());
    }
    ...
    public VrpPathWithTravelData getVrpPathWithTravelData() {
        return (directive instanceof FuturePathDirective ? ((FuturePathDirective) directive).getFuturePathContainer().getVrpPathWithTravelData() : null);
    }
    ...
    public boolean equals(Object o) {
        ...
        RoboTaxi taxi = (RoboTaxi) o;
        return Objects.equals(avVehicle, taxi.avVehicle);
    }

    @Override
    public int hashCode() {
        return Objects.hash(avVehicle);
    }
}
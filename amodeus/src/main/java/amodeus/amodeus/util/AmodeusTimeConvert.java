...
public class AmodeusTimeConvert {
    ...
    public static int simDuration(FTMConfigGroup ftmConfigGroup) {
        return (int) java.time.Duration.between(ftmConfigGroup.getSimStartDateTime(), ftmConfigGroup.getSimEndDateTime()).getSeconds();
    }

    public static int toSimulationTime(LocalDateTime time, FTMConfigGroup ftmConfigGroup) {
        return (int) java.time.Duration.between(ftmConfigGroup.getSimStartDateTime(), time).getSeconds();
    }

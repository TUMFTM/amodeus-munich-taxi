...
public class RequestContainer implements Serializable {
    ...
    public int associatedVehicle = -1; // vehicle currently associated to request, e.g., assigned for pickup
    public int passengerId = -1; // id of the person from the population.xml
}

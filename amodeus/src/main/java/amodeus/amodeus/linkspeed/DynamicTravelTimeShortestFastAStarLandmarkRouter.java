...
public class DynamicTravelTimeShortestFastAStarLandmarkRouter implements AmodeusRouter {
    private final ParallelLeastCostPathCalculator delegate;

    public DynamicTravelTimeShortestFastAStarLandmarkRouter(ParallelLeastCostPathCalculator delegate) {
    ...
    public static class Factory implements AmodeusRouter.Factory {
        ...
        public AmodeusRouter createRouter(InstanceGetter inject) {
            ...
            return new DynamicTravelTimeShortestFastAStarLandmarkRouter(DefaultParallelLeastCostPathCalculator.create((int) config.getNumberOfParallelRouters(), //
                    new FastAStarLandmarksFactory(inject.get(GlobalConfigGroup.class)), network, new TravelDisutility() {
                        @Override
